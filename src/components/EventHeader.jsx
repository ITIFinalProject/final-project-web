...
const EventHeader = () => {
  ...
  return (
    <header className="event-header">
      <nav className="navbar navbar-expand-lg navbar-dark">
        <div className="container">
          <NavLink className="navbar-brand" to="/" onClick={() => setIsNavOpen(false)}>
            <IoCalendar /> Eventify
          </NavLink>
          ...
          >
            <ul className="navbar-nav me-auto">
              <li className="nav-item">
                <NavLink className="nav-link" to="/" onClick={() => setIsNavOpen(false)}>
                  Home
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/Events" onClick={() => setIsNavOpen(false)}>
                  Events
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/InterestedEvents" onClick={() => setIsNavOpen(false)}>
                  Interested
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="/SignUp" onClick={() => setIsNavOpen(false)}>
                  Sign Up
                </NavLink>
              </li>
            </ul>
